...
class VeRi(BaseImageDataset):
    ...
    def __init__(self, root='/home/yangy/yy/github/AICITY2020_DMT_VehicleReID/data', verbose=True, **kwargs):
        super(VeRi, self).__init__()
        root = '/home/yangy/yy/github/AICITY2020_DMT_VehicleReID/data'
